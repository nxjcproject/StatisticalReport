...
namespace StatisticalReport.Service.ComprehensiveReport
{
    public static class CoalConsumptionReportService
    {
        ...
        /// <returns></returns>
        public static DataTable GetCoalConsumptionDailyByOrganiztionIds(string[] organizationIds)
        {
            return GetCoalConsumptionDailyByOrganiztionIds(organizationIds, DateTime.Now.AddDays(-1));
        }
        ...
        /// <returns></returns>
        public static DataTable GetCoalConsumptionDailyByOrganiztionIds(string[] organizationIds, DateTime time)
        {
