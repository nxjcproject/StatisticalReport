...
namespace StatisticalReport.Service.ComprehensiveReport
{
    public static class ElectricityUsageReportService
    {
        ...
        /// <returns></returns>
        public static DataTable GetElectricityUsageDailyByOrganiztionIds(string[] organizationIds)
        {
            return GetElectricityUsageDailyByOrganiztionIds(organizationIds, DateTime.Now.AddDays(-1));
        }
        ...
        /// <returns></returns>
        public static DataTable GetElectricityUsageDailyByOrganiztionIds(string[] organizationIds, DateTime time)
        {
