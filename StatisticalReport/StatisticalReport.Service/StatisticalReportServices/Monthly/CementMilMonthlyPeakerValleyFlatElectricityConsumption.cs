...
namespace StatisticalReport.Service.StatisticalReportServices.Monthly
{
    public class CementMilMonthlyPeakerValleyFlatElectricityConsumption
    {
        ...
        public static DataTable TableQuery(string organizationID, string date)
        {
            ...
            DataTable temp2 = _tzHelper.GetReportData("tz_Report", organizationID, date, "report_CementMillMonthlyOutput");
            foreach (DataRow dr in temp2.Rows)
            {
                DataRow newRow = temp1.NewRow();
                newRow["vDate"] = (string)(dr["vDate"]);
                newRow["First_Output"] = (decimal)dr["CementProductionFirstShift"];
                newRow["Second_Output"] = (decimal)dr["CementProductionSecondShift"];
                newRow["Third_Output"] = (decimal)dr["CementProductionThirdShift"];
                temp1.Rows.Add(newRow);
            }

            DataTable temp3 = _tzHelper.GetReportData("tz_Report", organizationID, date, "report_CementMillMonthlyElectricity_peak");
            ...
            DataTable temp4 = _tzHelper.GetReportData("tz_Report", organizationID, date, "report_CementMillMonthlyElectricity_valley");
            ...
            DataTable temp5 = _tzHelper.GetReportData("tz_Report", organizationID, date, "report_CementMillMonthlyElectricity_flat");
