...
namespace StatisticalReport.Service.StatisticalReportServices.Monthly                           //zcs
{
    public class CementMilMonthlyPeakerValleyFlatElectricityConsumption
    {
        ...
        static CementMilMonthlyPeakerValleyFlatElectricityConsumption()
        {
        ...
        {
            DataTable temp1 = _tzHelper.CreateTableStructure("report_CementMilMonthlyPeakerValleyFlatElectricityConsumption");

            DataTable temp2 = _tzHelper.GetReportData("tz_Report", organizationID, date, "table_CementMillMonthlyOutput");
            foreach (DataRow dr in temp2.Rows)
            {
                DataRow newRow = temp1.NewRow();
                newRow["vDate"] = (string)(dr["vDate"]);
                newRow["First_Output"] = Convert.ToInt64(dr["CementProductionFirstShift"]);
                newRow["Second_Output"] = Convert.ToInt64(dr["CementProductionSecondShift"]);
                newRow["Third_Output"] = Convert.ToInt64(dr["CementProductionThirdShift"]);
                temp1.Rows.Add(newRow);
            }

            DataTable temp3 = _tzHelper.GetReportData("tz_Report", organizationID, date, "table_CementMillMonthlyElectricity_peak");
            ...
            DataTable temp4 = _tzHelper.GetReportData("tz_Report", organizationID, date, "table_CementMillMonthlyElectricity_valley");
            ...
            DataTable temp5 = _tzHelper.GetReportData("tz_Report", organizationID, date, "table_CementMillMonthlyElectricity_flat");
