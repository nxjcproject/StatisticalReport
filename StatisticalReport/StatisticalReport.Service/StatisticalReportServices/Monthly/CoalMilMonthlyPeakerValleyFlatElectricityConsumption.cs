...
{
    public class CoalMilMonthlyPeakerValleyFlatElectricityConsumption
    {
        ...
        public static DataTable TableQuery(string organizationID, string date)
        {
            ...
            foreach (DataRow dr in temp2.Rows)
            {
                ...
                newRow["First_Output"] = (decimal)dr["CoalDustProductionFirstShift"];
                newRow["Second_Output"] = (decimal)dr["CoalDustProductionSecondShift"];
                newRow["Third_Output"] = (decimal)dr["CoalDustProductionThirdShift"];
            ...
            foreach (DataRow dr in temp3.Rows)
            {
                DataRow newRow = temp1.NewRow();
                newRow["vDate"] = (string)dr["vDate"];
                newRow["First_Peak_Electricity"] = (decimal)dr["CoalMillSystemFirstShift"];
                newRow["Second_Peak_Electricity"] = (decimal)dr["CoalMillSystemSecondShift"];
                newRow["Third_Peak_Electricity"] = (decimal)dr["CoalMillSystemThirdShift"];
                temp1.Rows.Add(newRow);
            }
            ...
            foreach (DataRow dr in temp4.Rows)
            {
                DataRow newRow = temp1.NewRow();
                newRow["vDate"] = (string)dr["vDate"];
                newRow["First_Valley_Electricity"] = (decimal)dr["CoalMillSystemFirstShift"];
                newRow["Second_Valley_Electricity"] = (decimal)dr["CoalMillSystemSecondShift"];
                newRow["Third_Valley_Electricity"] = (decimal)dr["CoalMillSystemThirdShift"];
                temp1.Rows.Add(newRow);
            }
            ...
            foreach (DataRow dr in temp5.Rows)
            {
                DataRow newRow = temp1.NewRow();
                newRow["vDate"] = (string)dr["vDate"];
                newRow["First_Flat_Electricity"] = (decimal)dr["CoalMillSystemFirstShift"];
                newRow["Second_Flat_Electricity"] = (decimal)dr["CoalMillSystemSecondShift"];
                newRow["Third_Flat_Electricity"] = (decimal)dr["CoalMillSystemThirdShift"];
                temp1.Rows.Add(newRow);
            }
