...
{
    public class AmmeterPeakerValleyFlatYear                //zcs
    {
        private static string connectionString;
        private static TZHelper _tzHelper;

        static AmmeterPeakerValleyFlatYear()//静态构造函数
        {
        ...
        {
            DataTable sourceTable = _tzHelper.GetReportData("tz_Report", organizationID, date, "table_AmmeterPeakerValleyFlatYear");
