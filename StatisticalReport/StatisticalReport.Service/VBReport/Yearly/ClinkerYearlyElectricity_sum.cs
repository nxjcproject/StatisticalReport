...
{
    public static class ClinkerYearlyElectricity_sum        //cdy
    {
        private static string connectionString;
        private static TZHelper _tzHelper;

        static ClinkerYearlyElectricity_sum()//静态构造函数
        {
        ...
        {
            DataTable temp2 = _tzHelper.GetReportData("tz_Report", organizeID, date, "table_ClinkerYearlyElectricity_sum");
