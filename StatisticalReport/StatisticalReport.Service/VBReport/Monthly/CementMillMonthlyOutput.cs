...
{
    public class CementMillMonthlyOutput                   //cdy
    {
        private static string connectionString;
        private static TZHelper _tzHelper;

        static CementMillMonthlyOutput()//静态构造函数
        {
        ...
        {
            DataTable temp2 = _tzHelper.GetReportData("tz_Report", organizeID, date, "table_CementMillMonthlyOutput");
