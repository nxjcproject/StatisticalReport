...
function loadGridData(myLoadType, organizationId, startDate, endDate) {
    ...
    $.ajax({
        type: "POST",
        url: "EnvironmentalStatisticalReport.aspx/GetEnvironmentalStatisticalReport",
...
function GetShiftsSchedulingLog(organizationId, startDate, endDate) {
    var queryUrl = 'EnvironmentalStatisticalReport.aspx/GetShiftsSchedulingLog';
...
function ExportFileFun() {
    ...
    var m_Parameter1 = GetDataGridTableHtml("gridMain_ReportTemplate", "环境统计报表", SelectDatetime);
    ...
    form.attr('action', "EnvironmentalStatisticalReport.aspx");
...
function PrintFileFun() {
    var m_ReportTableHtml = GetDataGridTableHtml("gridMain_ReportTemplate", "环境统计报表", SelectDatetime);
