<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnergyConsumptionDetailReport.aspx.cs" Inherits="StatisticalReport.Web.UI_BasicDataSummaryReport.EnergyConsumptionDetailReport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="/UI_BasicDataSummaryReport/js/page/EnergyConsumptionDetailReport.js" charset="utf-8"></script>
</head>
<body>
    <div class="easyui-layout" data-options="fit:true,border:false">
        ...
        <div data-options="region:'center', border: true, collapsible: false, split: false">
            <table id="grid_EnergyConsumptionDetailReport"></table>
        </div>
        <div id="toolbar_EnergyConsumptionDetailReport" style="display: none;">
            <table>
                <tr>
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input id="productionLineName" class="easyui-textbox" style="width: 120px;" readonly="true" />
                        ...
                        <table>
                            <tr>                             
                                ...
                                <td style="width: 315px; text-align: right;">
                                    <input type="checkbox" name="checked" id="checked" checked="checked" />是否包括设备                                   
                                </td>
                            </tr>
                        </table>
                    </td>
