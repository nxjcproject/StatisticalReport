<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_EnergyConsumptionMonthlyStatisticAnalysis.aspx.cs" Inherits="StatisticalReport.Web.UI_StatisticalReport.Monthly.report_EnergyConsumptionMonthlyStatisticAnalysis" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="../js/page/Monthly/report_EnergyConsumptionMonthlyStatisticAnalysis.js" charset="utf-8"></script>
</head>
<body>
                ...
                <tr>
	                <td>
		                <table>
			                <tr>
				                <td>生产线：</td>
		                        <td><input id="productLineName" class="easyui-textbox" style="width:120px;" readonly="true" /><input id="organizationId" readonly="true" style="display:none;"/><input id="productLineType" readonly="true" style="display:none;"/></td>
				                <td>时间：</td>
