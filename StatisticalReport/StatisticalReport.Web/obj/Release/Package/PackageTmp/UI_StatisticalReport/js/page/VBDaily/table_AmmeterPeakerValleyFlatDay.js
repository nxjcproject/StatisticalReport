...
function loadGridData(myLoadType, organizationId, datetime,reportType) {
    ...
    $.ajax({
        type: "POST",
        url: "table_AmmeterPeakerValleyFlatDay.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "table_AmmeterPeakerValleyFlatDay.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "table_AmmeterPeakerValleyFlatDay.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
