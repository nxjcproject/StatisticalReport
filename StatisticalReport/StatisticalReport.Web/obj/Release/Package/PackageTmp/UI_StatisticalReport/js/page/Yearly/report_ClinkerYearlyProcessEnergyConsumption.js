...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "report_ClinkerYearlyProcessEnergyConsumption.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "report_ClinkerYearlyProcessEnergyConsumption.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_ClinkerYearlyProcessEnergyConsumption.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
