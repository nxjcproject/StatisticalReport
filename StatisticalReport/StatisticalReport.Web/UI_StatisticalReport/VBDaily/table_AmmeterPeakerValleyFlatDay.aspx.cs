...
{
    public partial class table_AmmeterPeakerValleyFlatDay : WebStyleBaseForEnergy.webStyleBase
    {
        private const string REPORT_TEMPLATE_PATH = "\\VBReportHeaderTemplate\\table_AmmeterPeakerValleyFlatDay.xml";
