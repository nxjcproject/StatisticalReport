...
{
    public partial class table_FormulaGroupDay : WebStyleBaseForEnergy.webStyleBase
    {
        private const string REPORT_TEMPLATE_PATH = "\\VBReportHeaderTemplate\\table_FormulaGroupDay.xml";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "table_FormulaGroupDay.aspx";                                     //向web用户控件传递当前调用的页面名称
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                StatisticalReportHelper.ExportExcelFile("xls", "电表峰谷平（班组）用电日统计表.xls", m_HtmlData);
            }
        }
        ...
        public static string GetReportData(string organizationId, string datetime)
        {
            ...
            myDataTable = FormulaGroupDay.TableQuery(organizationId, datetime);
