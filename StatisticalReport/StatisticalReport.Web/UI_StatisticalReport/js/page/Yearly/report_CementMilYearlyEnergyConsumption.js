...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "report_CementMilYearlyEnergyConsumption.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "report_CementMilYearlyEnergyConsumption.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_CementMilYearlyEnergyConsumption.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
