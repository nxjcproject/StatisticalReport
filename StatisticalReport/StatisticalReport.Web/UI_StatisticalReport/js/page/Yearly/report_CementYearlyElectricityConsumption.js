...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "report_CementYearlyElectricityConsumption.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "report_CementYearlyElectricityConsumption.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_CementYearlyElectricityConsumption.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
