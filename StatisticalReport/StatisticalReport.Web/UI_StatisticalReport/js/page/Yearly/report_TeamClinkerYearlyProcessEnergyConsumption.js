...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "report_TeamClinkerYearlyProcessEnergyConsumption.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "report_TeamClinkerYearlyProcessEnergyConsumption.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_TeamClinkerYearlyProcessEnergyConsumption.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
