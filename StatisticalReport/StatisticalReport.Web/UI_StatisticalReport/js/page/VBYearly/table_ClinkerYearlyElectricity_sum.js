...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "table_ClinkerYearlyElectricity_sum.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "table_ClinkerYearlyElectricity_sum.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "table_ClinkerYearlyElectricity_sum.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
