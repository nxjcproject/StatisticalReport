...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "table_AmmeterPeakerValleyFlatYear.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "table_AmmeterPeakerValleyFlatYear.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "table_AmmeterPeakerValleyFlatYear.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
