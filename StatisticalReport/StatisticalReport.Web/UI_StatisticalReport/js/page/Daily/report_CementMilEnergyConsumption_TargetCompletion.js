...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "report_CementMilEnergyConsumption_TargetCompletion.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "report_CementMilEnergyConsumption_TargetCompletion.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_CementMilEnergyConsumption_TargetCompletion.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
