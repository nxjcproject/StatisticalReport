...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "report_CementMilMonthlyPeakerValleyFlatElectricityConsumption.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "report_CementMilMonthlyPeakerValleyFlatElectricityConsumption.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_CementMilMonthlyPeakerValleyFlatElectricityConsumption.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
