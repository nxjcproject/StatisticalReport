...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "report_CementMonthlyElectricityConsumption.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "report_CementMonthlyElectricityConsumption.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_CementMonthlyElectricityConsumption.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
