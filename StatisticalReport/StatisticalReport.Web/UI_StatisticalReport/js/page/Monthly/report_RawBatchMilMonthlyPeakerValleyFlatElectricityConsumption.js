...
function loadGridData(myLoadType, organizationId, datetime) {
    ...
    $.ajax({
        type: "POST",
        url: "report_RawBatchMilMonthlyPeakerValleyFlatElectricityConsumption.aspx/GetReportData",
...
function ExportFileFun() {
    ...
    form.attr('action', "report_RawBatchMilMonthlyPeakerValleyFlatElectricityConsumption.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_RawBatchMilMonthlyPeakerValleyFlatElectricityConsumption.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
