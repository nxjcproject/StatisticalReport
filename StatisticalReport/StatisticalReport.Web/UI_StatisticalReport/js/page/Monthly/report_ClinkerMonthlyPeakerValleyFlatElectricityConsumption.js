...
function ExportFileFun() {
    ...
    form.attr('action', "report_ClinkerMonthlyPeakerValleyFlatElectricityConsumption.aspx");
...
function PrintFileFun() {
    $.ajax({
        type: "POST",
        url: "report_ClinkerMonthlyPeakerValleyFlatElectricityConsumption.aspx/PrintFile",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
