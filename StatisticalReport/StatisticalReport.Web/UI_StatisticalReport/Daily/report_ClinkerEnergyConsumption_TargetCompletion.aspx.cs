...
namespace StatisticalReport.Web.UI_StatisticalReport.Daily
{
    public partial class report_ClinkerEnergyConsumption_TargetCompletion : WebStyleBaseForEnergy.webStyleBase
    {
        private const string REPORT_TEMPLATE_PATH = "\\ReportHeaderTemplate\\report_ClinkerEnergyConsumption_TargetCompletion.xml";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "report_ClinkerEnergyConsumption_TargetCompletion.aspx";                     //向web用户控件传递当前调用的页面名称
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                StatisticalReportHelper.ExportExcelFile("xls", "熟料能耗指标完成情况报表.xls", m_HtmlData);
            }
        }
        ...
        public static string GetReportData(string organizationId, string datetime)
        {
            ...
            myDataTable = ClinkerEnergyConsumption_TargetCompletion.TableQuery(organizationId, datetime);
