...
{
    public partial class table_FormulaMonth : WebStyleBaseForEnergy.webStyleBase
    {
        private const string REPORT_TEMPLATE_PATH = "\\VBReportHeaderTemplate\\table_FormulaMonth.xml";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "table_FormulaMonth.aspx";                                     //向web用户控件传递当前调用的页面名称
        ...
        public static string GetReportData(string organizationId, string datetime)
        {
            ...
            myDataTable = FormulaMonth.TableQuery(organizationId, datetime);
