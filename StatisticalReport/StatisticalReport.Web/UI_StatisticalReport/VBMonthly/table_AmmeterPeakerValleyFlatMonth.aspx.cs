...
{
    public partial class table_AmmeterPeakerValleyFlatMonth : WebStyleBaseForEnergy.webStyleBase
    {
        private const string REPORT_TEMPLATE_PATH = "\\VBReportHeaderTemplate\\table_AmmeterPeakerValleyFlatMonth.xml";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "table_AmmeterPeakerValleyFlatMonth.aspx";                                     //向web用户控件传递当前调用的页面名称
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                StatisticalReportHelper.ExportExcelFile("xls", "电表峰谷平用电月统计表.xls", m_HtmlData);
            }
        }
        ...
        public static string GetReportData(string organizationId, string datetime)
        {
            ...
            myDataTable = AmmeterPeakerValleyFlatMonth.TableQuery(organizationId, datetime);
