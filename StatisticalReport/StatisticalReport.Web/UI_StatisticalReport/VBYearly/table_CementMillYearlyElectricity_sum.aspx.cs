...
namespace StatisticalReport.Web.UI_StatisticalReport.VBYearly
{
    public partial class table_CementMillYearlyElectricity_sum : WebStyleBaseForEnergy.webStyleBase
    {
        private const string REPORT_TEMPLATE_PATH = "\\VBReportHeaderTemplate\\table_CementMillYearlyElectricity_sum.xml";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "table_CementMillYearlyElectricity_sum.aspx";                                     //向web用户控件传递当前调用的页面名称
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                StatisticalReportHelper.ExportExcelFile("xls", "水泥（分品种）粉磨用电量统计年报表.xls", m_HtmlData);
            }
        }
        ...
        public static string GetReportData(string organizationId, string datetime)
        {
            ...
            myDataTable = CementMillYearlyElectricity_sum.TableQuery(organizationId, datetime);
