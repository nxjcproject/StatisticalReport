...
{
    public partial class report_CementMilMonthlyEnergyConsumption : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "report_CementMilMonthlyEnergyConsumption.aspx";                                     //向web用户控件传递当前调用的页面名称
        ...
        public static string GetReportData(string organizationId, string datetime)
        {
            ...
            myDataTable = CementMilMonthlyEnergyConsumption.TableQuery(organizationId, datetime);
