...
{
    public partial class report_CoalMilMonthlyPeakerValleyFlatElectricityConsumption : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "report_CoalMilMonthlyPeakerValleyFlatElectricityConsumption.aspx";                                     //向web用户控件传递当前调用的页面名称
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                StatisticalReportHelper.ExportExcelFile("xls", "煤磨(峰谷平)用电月统计分析报表.xls", m_HtmlData);
            }
        }
        ...
        public static string GetReportData(string organizationId, string datetime)
        {
            ...
            myDataTable = CoalMilMonthlyPeakerValleyFlatElectricityConsumption.TableQuery(organizationId, datetime);
