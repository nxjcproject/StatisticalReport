...
{
    public partial class report_TeamClinkerYearlyProcessEnergyConsumption : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "report_TeamClinkerYearlyProcessEnergyConsumption.aspx";                                     //向web用户控件传递当前调用的页面名称
