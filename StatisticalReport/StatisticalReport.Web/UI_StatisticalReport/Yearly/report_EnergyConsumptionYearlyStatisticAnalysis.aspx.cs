...
{
    public partial class report_EnergyConsumptionYearlyStatisticAnalysis : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "report_EnergyConsumptionYearlyStatisticAnalysis.aspx";                                     //向web用户控件传递当前调用的页面名称
        ...
        public static string GetReportData(string organizationId, string datetime)
        {
            ...
            myDataTable = EnergyConsumptionYearlyStatisticAnalysis.TableQuery(organizationId, datetime);
