...
{
    public partial class report_CementYearlyElectricityConsumption : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "report_CementYearlyElectricityConsumption.aspx";                                     //向web用户控件传递当前调用的页面名称
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                string m_HtmlData = StatisticalReportHelper.CreateExportHtmlTable(mFileRootPath +
                    "\\ReportHeaderTemplate\\report_CementYearlyElectricityConsumption.xml", myDataTable, m_TagData);
                StatisticalReportHelper.ExportExcelFile("xls", "水泥（分品种）粉磨电耗年统计分析报表.xls", m_HtmlData);
            }
        }
