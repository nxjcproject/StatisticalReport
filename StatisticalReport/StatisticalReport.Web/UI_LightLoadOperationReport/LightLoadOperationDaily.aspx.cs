...
#if DEBUG
            ////////////////////调试用,自定义的数据授权
            List<string> m_DataValidIdItems = new List<string>() { "zc_nxjc_qtx", "zc_nxjc_byc_byf", "zc_nxjc_ychc", "zc_nxjc_tsc", "zc_nxjc_szsc", "zc_nxjc_klqc", "zc_nxjc_ychc_lsf", "zc_nxjc_znc" };
